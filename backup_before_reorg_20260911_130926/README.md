...
├── assets/js/proyector_logic.js   # Lógica compartida proyector (Firebase listeners, timer, ranking, countdown)
├── assets/images/logo_luxto.png       # Logo del grupo
├── assets/images/foto_grupo.jpg       # Foto grupal (hero)
